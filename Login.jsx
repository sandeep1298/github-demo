...
export default function Login(){
        ...
        .then(data =>{
            console.log(data)
             if(data.error){
                 ...
                 toast.success("Loggedin Successfully, Welcome to my blog, Now you can create your own post and you can update your Profile",{position:toast.POSITION.TOP_CENTER},{delay:15000});
                 history.push('/')
             } 
        }).catch(err=>{
            console.log(err)
    ...
    return(
        ...
        <div className="container mt-5 pt-5 mb-5 flex-center">
            <div className="card">
                <h3 className="text-center card-header text-white secondary-color font-weight-bold ">Login Page</h3>
