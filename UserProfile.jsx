            ...
            <div className="container mt-3 pt-4 ">
                <div className="row ">
                    <div className="col-lg-3 col-md-4 col-sm-12 col-12 image-center">
                        <img className=" img-fluid" style={{width:"160px",height:"160px",borderRadius:"80px"}} src={userProfile.user.photo} alt="profileimage"/>
                    </div>
                    <div className="col-lg-9 col-md-8 col-sm-12 col-12 mt-3 name-center">
                       ...
                       {/*} {showfollow?
                            <button className="btn  text-white border-align "  onClick={()=>followUser()}>Follow</button>
                            :
                            <button className="btn  text-white border-align "  onClick={()=>unfollowUser()}>UnFollow</button>
                        }*/}
